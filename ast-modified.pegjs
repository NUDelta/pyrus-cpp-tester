...
TypedefDeclaration
    = TYPEDEF a:DeclarationSpecifiers b:Declarator c:(COMMA d:Declarator {return d;})* SEMI {
...
FunctionDirectDeclarator
    = a1:( a:Identifier {return addPositionInfo({type:'Identifier', Identifier:a});}
...
ParameterList
    = a1:ParameterDeclaration? b:(COMMA a:ParameterDeclaration {return a;})* {
      if (a1)
        return [a1].concat(b);
      else
        return b;
...
InitializerList
    = a1:Initializer b:(COMMA a:Initializer {return a;})* {return [a1].concat(b);}
    ;
...
ScopedIdentifier
    = a1:SCOPEOP? b:(a:Identifier SCOPEOP {return a;})* c:Identifier {
